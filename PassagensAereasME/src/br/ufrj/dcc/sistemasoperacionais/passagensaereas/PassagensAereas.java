/*
 * PassagensAereas.java
 *
 * Created on 20 de Novembro de 2007, 22:00
 */
...
public class PassagensAereas extends MIDlet implements CommandListener{
    ...
    StringItem fracassoCompra = new StringItem("Compra não efetuada!", "Compra não efetuada!");
    int compra;
    ...
    public void getPrincipal(Vector trechos, boolean sucesso, boolean comprou) {
        principal = new Form("Passagens Aéreas");
        ...
        if (!comprou) {
            ...
            if (sucesso) {
                //principal.delete(midlet.compra);
                //principal.insert(midlet.compra, midlet.sucessoCompra);
                compra = principal.append(sucessoCompra);
            } else {
                //principal.delete(midlet.compra);
                //principal.insert(midlet.compra, midlet.fracassoCompra);
